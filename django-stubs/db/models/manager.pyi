...
_TQ = TypeVar("_TQ", bound=QuerySet, covariant=True, default=QuerySet[_T])

class BaseManager(Generic[_T, _TQ]):
    ...
    def none(self) -> _TQ: ...
    def all(self) -> _TQ: ...
    def filter(self, *args: Any, **kwargs: Any) -> _TQ: ...
    def exclude(self, *args: Any, **kwargs: Any) -> _TQ: ...
    def complex_filter(self, filter_obj: Any) -> _TQ: ...
    def count(self) -> int: ...
    async def acount(self) -> int: ...
    def union(self, *other_qs: Any, all: bool = ...) -> _TQ: ...
    def intersection(self, *other_qs: Any) -> _TQ: ...
    def difference(self, *other_qs: Any) -> _TQ: ...
    def select_for_update(
        self, nowait: bool = ..., skip_locked: bool = ..., of: Sequence[str] = ..., no_key: bool = ...
    ) -> _TQ: ...
    def select_related(self, *fields: Any) -> _TQ: ...
    def prefetch_related(self, *lookups: Any) -> _TQ: ...
    def annotate(self, *args: Any, **kwargs: Any) -> _TQ: ...
    def alias(self, *args: Any, **kwargs: Any) -> _TQ: ...
    def order_by(self, *field_names: Any) -> _TQ: ...
    def distinct(self, *field_names: Any) -> _TQ: ...
    ...
    def reverse(self) -> _TQ: ...
    def defer(self, *fields: Any) -> _TQ: ...
    def only(self, *fields: Any) -> _TQ: ...
    def using(self, alias: str | None) -> _TQ: ...
    @property
    def ordered(self) -> bool: ...

class Manager(BaseManager[_T, _TQ]): ...
